                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('salary_heights.salary_height.show', $salaryHeight->id ) }}" class="btn btn-primary" title="Show Salary Height">
                                            <span class="fa fa-eye" aria-hidden="true"></span>
                                        </a>
                                        <a href="{{ route('salary_heights.salary_height.edit', $salaryHeight->id ) }}" class="btn btn-warning" title="Edit Salary Height">

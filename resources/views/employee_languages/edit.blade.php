...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title mb-1">Edit Employee Language</h3>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('employee_languages.employee_language.update', $employeeLanguage->id) }}" id="edit_employee_language_form" name="edit_employee_language_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}

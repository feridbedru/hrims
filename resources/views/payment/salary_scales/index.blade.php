        ...
        <table class="table table-striped ">
                    ...
                    @foreach($salaryScales as $salaryScale)
                        <tr>
                            ...
                            <td>{{ optional($salaryScale->jobCategory)->name }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('salary_scales.salary_scale.show', $salaryScale->id ) }}" class="btn btn-primary" title="Show Salary Scale">
                                            <span class="fa fa-eye" aria-hidden="true"></span>
                                        </a>
                                        <a href="{{ route('salary_scales.salary_scale.edit', $salaryScale->id ) }}" class="btn btn-warning" title="Edit Salary Scale">

...
<div class="row">
    ...
    <div class="form-group col-md-2 {{ $errors->has('is_enabled') ? 'has-error' : '' }}">
        <label for="is_enabled" class="col-md-12 control-label">Is Enabled</label>
        <div class="col-md-12">
            <div class="checkbox">
...
<div class="row">
    ...
    <div class="form-group col-md-4 {{ $errors->has('stair_height') ? 'has-error' : '' }}">
        <label for="stair_height" class="col-md-12 control-label">Stair Height <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4 {{ $errors->has('salary_steps') ? 'has-error' : '' }}">
        <label for="salary_steps" class="col-md-12 control-label">Salary Steps <span
                class="text-danger">*</span></label>
        <div class="col-md-12">

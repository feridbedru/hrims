...
<div class="row">
    ...
    <div class="form-group col-md-5 {{ $errors->has('am_name') ? 'has-error' : '' }}">
        <label for="am_name" class="col-md-12 control-label">{{(__('setting.AmharicName'))}} <span class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    ...
    <div class="form-group col-md-4 {{ $errors->has('header') ? 'has-error' : '' }}">
        <label for="header" class="col-md-12 control-label">{{_(__('setting.Header'))}}</label>
        <div class="col-md-12">
            <div class="input-group uploaded-file-group">
                <label class="input-group-btn">
                    <span class="btn btn-default">

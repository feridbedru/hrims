...
<div class="form-group col-md-6 {{ $errors->has('en_name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="en_name" type="text" id="en_name" value="{{ old('en_name', optional($organization)->en_name) }}" minlength="5" required="true" placeholder="Enter English name here...">
...
<div class="form-group col-md-6 {{ $errors->has('am_name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="am_name" type="text" id="am_name" value="{{ old('am_name', optional($organization)->am_name) }}" minlength="5" placeholder="Enter amharic name here...">
...
<div class="form-group col-md-4 {{ $errors->has('motto') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="motto" type="text" id="motto" value="{{ old('motto', optional($organization)->motto) }}" minlength="10" placeholder="Enter motto here...">
...
<div class="form-group col-md-4{{ $errors->has('mission') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="mission" type="text" id="mission" value="{{ old('mission', optional($organization)->mission) }}" minlength="10" placeholder="Enter mission here...">
...
<div class="form-group col-md-4{{ $errors->has('vision') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="vision" type="text" id="vision" value="{{ old('vision', optional($organization)->vision) }}" minlength="10" placeholder="Enter vision here...">
...
<div class="form-group col-md-4 {{ $errors->has('header') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        ...
        @if (isset($organization->header) && !empty($organization->header))
            <div class="input-group input-width-input">
                <span class="input-group-addon">
                    <input type="checkbox" name="custom_delete_header" class="custom-delete-file" value="1" {{ old('custom_delete_header', '0') == '1' ? 'checked' : '' }}> Delete
                </span>
    ...
    <div class="col-md-12">
        ...
        @if (isset($organization->footer) && !empty($organization->footer))
            <div class="input-group">
                <span class="input-group-addon">
                    <input type="checkbox" name="custom_delete_footer" class="custom-delete-file" value="1" {{ old('custom_delete_footer', '0') == '1' ? 'checked' : '' }}> Delete
                </span>
...
<div class="form-group col-md-4 {{ $errors->has('address') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="address" type="text" id="address" value="{{ old('address', optional($organization)->address) }}" minlength="10" placeholder="Enter address here...">
...
<div class="form-group col-md-4 {{ $errors->has('website') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="website" type="text" id="website" value="{{ old('website', optional($organization)->website) }}" minlength="10" placeholder="Enter website here...">
...
<div class="form-group col-md-4 {{ $errors->has('email') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="email" type="email" id="email" value="{{ old('email', optional($organization)->email) }}" placeholder="Enter email here...">
...
<div class="form-group col-md-4 {{ $errors->has('phone_number') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="phone_number" type="tel" id="phone_number" value="{{ old('phone_number', optional($organization)->phone_number) }}" min="0" placeholder="Enter phone number here...">
        {!! $errors->first('phone_number', '<p class="help-block">:message</p>') !!}
    </div>
</div>

<div class="form-group col-md-4 {{ $errors->has('fax_number') ? 'has-error' : '' }}">
    <label for="fax_number" class="col-md-4 control-label">Fax Number</label>
    <div class="col-md-12">
        <input class="form-control" name="fax_number" type="tel" id="fax_number" value="{{ old('fax_number', optional($organization)->fax_number) }}" min="0" placeholder="Enter fax number here...">
...
<div class="form-group col-md-4 {{ $errors->has('po_box') ? 'has-error' : '' }}">
    ...
    <div class="col-md-12">
        <input class="form-control" name="po_box" type="text" id="po_box" value="{{ old('po_box', optional($organization)->po_box) }}" minlength="1" placeholder="Enter PO Box here...">
        {!! $errors->first('po_box', '<p class="help-block">:message</p>') !!}
    </div>
</div>
</div>
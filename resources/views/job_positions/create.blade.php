...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
    <form method="POST" action="{{ route('job_positions.job_position.store') }}" accept-charset="UTF-8" id="create_job_position_form" name="create_job_position_form" class="form-horizontal">
            {{ csrf_field() }}

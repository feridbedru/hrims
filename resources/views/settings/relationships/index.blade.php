...
@endsection
@section('pagetitle')
{{(__('setting.Relationships'))}}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('settings.setting.index') }}">{{(__('setting.Setting'))}}</a></li>
    <li class="breadcrumb-item active">{{(__('setting.Relationships'))}}</li>
@endsection
@section('stylesheets')
...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">{{(__('setting.RelationshipsList'))}}</h3>
        </div>
        <div class="card-body">
            @permission('relationships_list')
            @if (count($relationships) == 0)
                <h4 class="text-center">{{__('setting.NoRelationshipsAvailable')}}.</h4>
            @else
    ...
    @permission('setting_Relationships_AddNew')
...
@section('javascripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#relationship_table_filter").addClass("d-inline float-right");
            $("<hr>").insertBefore("#relationship_table");
        });

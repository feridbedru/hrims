@extends('layouts.app')
@section('pagetitle')
{{(__('employee.Edit Organization Location'))}}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('settings.setting.index') }}">{{(__('setting.Setting'))}}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('organization_locations.organization_location.index') }}">{{(__('employee.Organization Location'))}}</a></li>
    ...
    <div class="card card-default">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title mb-1">{{(__('employee.Edit Organization Location'))}}</h3>
            </div>
        </div>
        <div class="card-body">
            <form method="POST"

                    ...
                    <tbody>
                        @foreach ($employeeBankAccounts as $employeeBankAccount)
                            <tr>
                                ...
                                <td>{{ optional($employeeBankAccount->employee)->en_name }}</td>
                                <td>{{ optional($employeeBankAccount->bank)->name }}</td>
                                <td>{{ optional($employeeBankAccount->bankAccountType)->name }}</td>

...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('type') ? 'has-error' : '' }}">
        <label for="type" class="col-md-4 control-label">{{ __('employee.Type') }} <span
    ...
    <div class="form-group col-md-4 {{ $errors->has('institution') ? 'has-error' : '' }}">
        <label for="institution" class="col-md-4 control-label">{{ __('employee.Institution') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4 {{ $errors->has('level') ? 'has-error' : '' }}">
        <label for="level" class="col-md-4 control-label">{{ __('setting.Level') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('field') ? 'has-error' : '' }}">
        <label for="field" class="col-md-4 control-label">{{ __('setting.Field') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4 {{ $errors->has('duration') ? 'has-error' : '' }}">
        <label for="duration" class="col-md-4 control-label">{{ __('employee.Duration') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    <div class="form-group col-md-2 {{ $errors->has('has_commitment') ? 'has-error' : '' }}">
        <label for="has_commitment" class="col-md-12 control-label">{{ __('employee.Has Commitment') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
            <div class="checkbox">
    ...
    <div class="form-group col-md-3 {{ $errors->has('total_commitment') ? 'has-error' : '' }}">
        <label for="total_commitment"
            class="col-md-12 control-label">{{ __('employee.Total Commitment(Month)') }}</label>
        <div class="col-md-12">

...
<div class="row">
    <div class="form-group col-md-6 {{ $errors->has('court_name') ? 'has-error' : '' }}">
        <label for="court_name" class="col-md-12 control-label">{{ __('setting.Court Name') }} <span
    ...
    <div class="form-group col-md-6 {{ $errors->has('punishment_type') ? 'has-error' : '' }}">
        <label for="punishment_type" class="col-md-12 control-label">{{ __('employee.Punishment Type') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    <div class="form-group col-md-6 {{ $errors->has('reason') ? 'has-error' : '' }}">
        <label for="reason" class="col-md-12 control-label">{{ __('employee.Reason') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    ...
    <div class="form-group col-md-4 {{ $errors->has('status') ? 'has-error' : '' }}">
        <label for="status" class="col-md-12 control-label">{{ __('employee.Status') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">

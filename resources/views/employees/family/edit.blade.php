...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title mb-1">Edit Employee Family</h3>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('employee_families.employee_family.update', $employeeFamily->id) }}" id="edit_employee_family_form" name="edit_employee_family_form" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}

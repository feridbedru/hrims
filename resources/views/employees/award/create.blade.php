...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title mb-1">Create New Employee Award</h3>
        ...
        <div class="card-body">
    <form method="POST" action="{{ route('employee_awards.employee_award.store') }}" accept-charset="UTF-8" id="create_employee_award_form" name="create_employee_award_form" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}

...
@section('pagetitle')
    Employee Disaster Witnesses
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item active">Employee Disaster Witnesses</li>
@endsection
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Employee Disaster Witnesses List</h3>
        ...
        @if(count($employeeDisasterWitnesses) == 0)
                <h4 class="text-center">No Employee Disaster Witnesses Available.</h4>
        @else
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('employee_disaster_witnesses.employee_disaster_witness.show', $employeeDisasterWitness->id ) }}" class="btn btn-primary" title="Show Employee Disaster Witness">
                                            <span class="fa fa-eye" aria-hidden="true"></span>
                                        </a>
                                        <a href="{{ route('employee_disaster_witnesses.employee_disaster_witness.edit', $employeeDisasterWitness->id ) }}" class="btn btn-warning" title="Edit Employee Disaster Witness">

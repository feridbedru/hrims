...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('level') ? 'has-error' : '' }}">
        <label for="level" class="col-md-12 control-label">{{ __('setting.Level') }} <span
    ...
    <div class="form-group col-md-4 {{ $errors->has('institute') ? 'has-error' : '' }}">
        <label for="institute" class="col-md-12 control-label">{{ __('employee.Institute') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4 {{ $errors->has('field') ? 'has-error' : '' }}">
        <label for="field" class="col-md-12 control-label">{{ __('Field') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
                ...
                <div class="input-group input-width-input">
                    <span class="input-group-addon mr-2">
                        <input type="checkbox" name="custom_delete_coc_file" class="custom-delete-file" value="1"
                            {{ old('custom_delete_coc_file', '0') == '1' ? 'checked' : '' }}>
                        {{ __('setting.delete') }}
                    </span>
                    <span class="input-group-addon custom-delete-file-name">
...
@section('javascripts')
    ...
    <script>
        $('#coc_issued_date').calendarsPicker({
            calendar: $.calendars.instance('ethiopian', 'am'),
            pickerClass: 'myPicker',
            dateFormat: 'yyyy-mm-dd'
        });

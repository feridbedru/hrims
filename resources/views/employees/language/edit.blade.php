...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title mb-1">Edit Language</h3>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('employee_languages.employee_language.update', ['employee' => $employee->id, 'employeeLanguage' => $employeeLanguage->id]) }}"

...
<div class="row">
    <div class="form-group col-md-6 {{ $errors->has('bank') ? 'has-error' : '' }}">
        <label for="bank" class="col-md-12 control-label">Bank <span class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-6 {{ $errors->has('account_type') ? 'has-error' : '' }}">
        <label for="account_type" class="col-md-12 control-label">Bank Account Type <span class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    <div class="form-group col-md-6 {{ $errors->has('account_number') ? 'has-error' : '' }}">
        <label for="account_number" class="col-md-12 control-label">Account Number <span class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-6 {{ $errors->has('file') ? 'has-error' : '' }}">
        <label for="file" class="col-md-12 control-label">File</label>
        <div class="col-md-12">

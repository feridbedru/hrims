...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('type') ? 'has-error' : '' }}">
        <label for="type" class="col-md-4 control-label">Experience Type <span class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4 {{ $errors->has('organization_address') ? 'has-error' : '' }}">
        <label for="organization_address" class="col-md-12 control-label">Organization Address <span class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('job_position') ? 'has-error' : '' }}">
        <label for="job_position" class="col-md-12 control-label">Job Position <span class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('left_reason') ? 'has-error' : '' }}">
        <label for="left_reason" class="col-md-12 control-label">Left Reason <span class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4  {{ $errors->has('start_date') ? 'has-error' : '' }}">
        <label for="start_date" class="col-md-12 control-label">Start Date <span class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4 {{ $errors->has('end_date') ? 'has-error' : '' }}">
        <label for="end_date" class="col-md-12 control-label">End Date <span class="text-danger">*</span></label>
        <div class="col-md-12">

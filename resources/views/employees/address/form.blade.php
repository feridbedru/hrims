...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('type') ? 'has-error' : '' }}">
        <label for="type" class="col-md-12 control-label">Address Type <span class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    <div class="form-group col-md-4">
        <label for="region" class="col-md-12 control-label">Region</label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4 {{ $errors->has('woreda') ? 'has-error' : '' }}">
        <label for="woreda" class="col-md-12 control-label">Woreda</label>
        <div class="col-md-12">

    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('additionalInfo_list')
                                        ...
                                        <form method="POST" action="{!! route('employee_additional_infos.employee_additional_info.destroy', ['employee' => $employeeAdditionalInfo->employees->id, 'employeeAdditionalInfo' => $employeeAdditionalInfo->id]) !!}" accept-charset="UTF-8">
                                            ...
                                            <div class="btn-group btn-group-xs pull-right" role="group">
                                                @permission('additionalInfo_edit')
                                                    ...
                                                    @endpermission
                                                    @permission('additionalInfo_delete')
                ...
                @if (count($employeeAdditionalInfos) == 0)
                    @permission('additionalInfo_addNew')
                    ...
                    @else
                        @permission('additionalInfo_print')
                            <a href="{{ route('employee_additional_infos.employee_additional_info.print', $employee) }}"
                                class="btn btn-primary" title="Print Employee Additional Info" target="_blank">

...
class EmployeeCertificationsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee_certifications.index', compact('employeeCertifications'));
    }
...
$approvedBies = User::pluck('name','id')->all();
        ...
        return view('employee_certifications.create', compact('employees','skillCategories','certificationVendors','creators','approvedBies'));
    }
    ...
    public function show($id)
    {
        ...
        return view('employee_certifications.show', compact('employeeCertification'));
    }
...
$approvedBies = User::pluck('name','id')->all();
        ...
        return view('employee_certifications.edit', compact('employeeCertification','employees','skillCategories','certificationVendors','creators','approvedBies'));
    }

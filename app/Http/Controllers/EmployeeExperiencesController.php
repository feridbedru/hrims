...
class EmployeeExperiencesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee_experiences.index', compact('employeeExperiences'));
    }
    ...
    public function create()
    {
        ...
        return view('employee_experiences.create', compact('employees','experienceTypes','leftReasons','creators','approvedBies'));
    }
    ...
    public function show($id)
    {
        ...
        return view('employee_experiences.show', compact('employeeExperience'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee_experiences.edit', compact('employeeExperience','employees','experienceTypes','leftReasons','creators','approvedBies'));
    }

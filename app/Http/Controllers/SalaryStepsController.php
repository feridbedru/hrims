...
class SalaryStepsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('salary_steps.create', compact('salaryScales'));
    }
    ...
    public function show($id)
    {
        ...
        return view('salary_steps.show', compact('salaryStep'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('salary_steps.edit', compact('salaryStep','salaryScales'));
    }

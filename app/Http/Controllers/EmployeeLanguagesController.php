...
class EmployeeLanguagesController extends Controller
{
    ...
    public function index()
    {
        ...
        ->paginate(25);
        return view('employee_languages.index', compact('employeeLanguages'));
    }
    ...
    public function create()
    {
        ...
        return view('employee_languages.create', compact('employees','languages','languageLevels','languageLevels','languageLevels','languageLevels','creators'));
    }
    ...
    public function show($id)
    {
        ...
        return view('employee_languages.show', compact('employeeLanguage'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee_languages.edit', compact('employeeLanguage','employees','languages','languageLevels','languageLevels','languageLevels','languageLevels','creators'));
    }

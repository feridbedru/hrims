...
class SalaryScalesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('salary_scales.index', compact('salaryScales'));
    }
    ...
    public function create()
    {
        ...
        return view('salary_scales.create', compact('jobCategories'));
    }
    ...
    public function show($id)
    {
        ...
        return view('salary_scales.show', compact('salaryScale'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('salary_scales.edit', compact('salaryScale','jobCategories'));
    }

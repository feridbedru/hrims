...
class EmployeeFamiliesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee_families.index', compact('employeeFamilies'));
    }
    ...
    public function create()
    {
        ...
        return view('employee_families.create', compact('employees','sexes','relationships','creators','approvedBies'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee_families.edit', compact('employeeFamily','employees','sexes','relationships','creators','approvedBies'));
    }

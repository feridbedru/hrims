...
class EmployeeFilesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee_files.index', compact('employeeFiles'));
    }
...
$creators = User::pluck('name','id')->all();
        ...
        return view('employee_files.create', compact('employees','creators'));
    }
    ...
    public function show($id)
    {
        ...
        return view('employee_files.show', compact('employeeFile'));
    }
...
$creators = User::pluck('name','id')->all();
        ...
        return view('employee_files.edit', compact('employeeFile','employees','creators'));
    }

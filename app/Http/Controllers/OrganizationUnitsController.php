...
class OrganizationUnitsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('organization_units.index', compact('organizationUnits','jobCategories','organizationLocations'));
    }
    ...
    public function create()
    {
        ...
        return view('organization_units.create', compact('organizationUnits','jobCategories','organizationLocations','chairmans'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('organization_units.edit', compact('organizationUnit','organizationUnits','jobCategories','organizationLocations','chairmans'));
    }
